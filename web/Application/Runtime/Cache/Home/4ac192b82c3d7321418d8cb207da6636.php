...
<div class="part1">
    <div class="container">
        <div class="part1-top">
            <h3><span>资质认证(上传真人头像)</span></h3>
        </div>

        <div class="part2-con">
           <form action="<?php echo U('Daikuan/completeInfo_two_add');?>" enctype="multipart/form-data" method="post" >
                ...
                <div class="upload">
                    <span>本地上传</span>
                    <input type="file" name="photo" value="本地上传" id="file0" />
                </div>
                <div>
...
<script type="text/javascript">
    $(function () {
        $("#file0").uploadPreview({ Img: "img0", Width: 120, Height: 120 });
    });
    jQuery.fn.extend({
    ...
    $(function(){
        ...
        $(".next-btn").click(function(){
            var val = $("#img0").attr("src");
            if(val!==""){
                $("#tiaozhuang").attr('type',"submit");
                //$(this).attr("href","completeInfo_three.html");
            }else{
                alert("请上传您的本人照片！");
            }
        })
