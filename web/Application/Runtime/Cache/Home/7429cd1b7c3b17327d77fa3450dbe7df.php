...
<div class="part1">
    <div class="container clearfix">
        <div class="part1-left">
            <h2><?php echo ($one["name"]); ?><br></h2>
            <p><span><?php echo ($one["releasetime"]); ?></span><span>浏览：<em><?php echo ($one["readnum"]); ?></em>次</span></p>
            <p><span>联系人：<em><?php echo ($one["linkman"]); ?></em></span></p>
            <p>
        ...
        <div class="part1-right">
            ...
            <ul class="clearfix">
                <li>
                    <p>预期收益率：<span class="red"><?php echo ($one["expectedreturn"]); ?></span></p>
                    <p>咨询电话：<span class="red"><?php echo ($one["linkphone"]); ?></span></p>
                    <p class="clearfix">
                ...
                <li>
                    <p>起投门槛：<span><?php echo ($one["threshold"]); ?></span></p>
                    <p>产品期限：<span><?php echo ($one["term"]); ?></span></p>
                </li>
                <li>
                    <p>产品规模：<span><?php echo ($one["scale"]); ?></span></p>
                    <p title=>资金用途：<span><?php echo ($one["useoffunds"]); ?></span></p>
                    <p title=>还款来源：<span><?php echo ($one["payment"]); ?></span></p>
                </li>
            </ul>
        </div>
    </div>
...
<div class="part2">
    <div class="container clearfix">
        <div class="part2-left">
            ...
            <ul>
                <li>
                    <h4>项目管理人：<span><?php echo ($one["administor"]); ?></span></h4>
                </li>
                <li>
                    <h4>项目托管人：<span><?php echo ($one["custodian"]); ?></span></h4>
                </li>
                <li>
                    <h4>收益分配方式：<span><?php echo ($one["incomedistribution"]); ?></span></h4>
                </li>
                <li>
                    <h4>产品描述：</h4>
                    <div class="content">
                        <p><?php echo ($one["productdescription"]); ?>。</p>
                    </div>
                </li>
                <li>
                    <h4>备注：</h4>
