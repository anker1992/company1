...
<div class="part1">
    <div class="container">
        ...
        <div class="part1-con">
            <form action="<?php echo U('Daikuan/completeInfo_one_add');?>" method="post">
                ...
                <div class="cityName-box clearfix mb30">
                    ...
                    <div class="province-box common-box">
                        <div class="province-con common-con">
                            <input type="text" class="province" name="province"/>
                            <i></i>
                        </div>
                ...
                <div class="organization-box mb30">
                    <span><i>*</i>所在机构</span>
                    <input type="text" class="organization" name="organization"/>
                    <label></label>
                </div>
                <div class="btn">
    ...
    $(function(){
        ...
        $(".next-btn").click(function(){
            ...
            if(val1=="" || val2==""||val3==""||val4 ==""){
                ...
                //$(this).attr("href","completeInfo_two.html");
            }
        })
    })
</script>
