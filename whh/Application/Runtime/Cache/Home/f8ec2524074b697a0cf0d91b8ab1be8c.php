...
<head lang="en">
    ...
    <link rel="stylesheet" href="/whh/Public/css/amazeui.min.css"/>
    <link rel="stylesheet" href="/whh/Public/css/commonHeader.css"/>
    <link rel="stylesheet" href="/whh/Public/css/productList.css"/>
</head>
<body>
...
<script type="text/javascript" src="/whh/Public/js/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="/whh/Public/js/amazeui.min.js"></script>
        ...
        $(".list-collection").click(function(){
            ...
            if(!oI.hasClass("cur")){
                ...
                $.ajax({
                    ...
                    data: {'token': token, 'he_id': he_id, 'status': '1'},
                    async: false,
